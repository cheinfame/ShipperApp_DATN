...
abstract class OrderRepository {
  ...
  // Accept an order
  Future<void> acceptOrder(String orderId, String shipperId,
      String shipperRouteId, List<List<double>> orderGeometry, double distance);

  // Start shipping an order
  Future<void> startShipping(String orderId);
