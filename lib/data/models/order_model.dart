...
class OrderWithInfo {
  ...
  OrderWithInfo copyWith({
    ...
    return OrderWithInfo(
      ...
      orderGeometry: orderGeometry ?? this.orderGeometry,
      shipperRouteId: shipperRouteId ?? this.shipperRouteId,
    );
  }

  factory OrderWithInfo.fromJson(Map<String, dynamic> json) =>
      _$OrderWithInfoFromJson(json);

  Map<String, dynamic> toJson() => _$OrderWithInfoToJson(this);
}
...
class Order {
  ...
  @JsonKey(fromJson: _orderStatusFromJson, toJson: orderStatusToJson)
  ...
  static String orderStatusToJson(OrderStatus status) {
    switch (status) {
      case OrderStatus.waiting:
        return 'waiting';
      case OrderStatus.verified:
  ...
  Order copyWith({
    ...
    return Order(
      ...
      shipperRoute: shipperRoute ?? this.shipperRoute,
