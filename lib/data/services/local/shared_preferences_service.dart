...
class SharedPreferencesService {
  ...
  final String isFirstTimeOpenApp = 'isFirstTimeOpenApp';
  final String currentNavigatingRouteId = 'currentNavigatingRouteId';
  final String currentNavigatingRouteDirection = 'currentNavigatingRouteDirection';
  // Initialize default values
  Future<void> setupDefaults() async {
    if (_prefs.getBool(isLoggedIn) == null) {
      await _prefs.setBool(isLoggedIn, false); // Default: Not logged in
    }
    if (_prefs.getBool(isFirstTimeOpenApp) == null) {
      await _prefs.setBool(
          isFirstTimeOpenApp, true); // Default: First time opening the app
    }
  }
